    ...
    handleResize: function(event) {
      ...
      switch (event.type) {
        ...
        case "resizemove": {
          ...
          if (this.renderRtl) {
            newSize.width =
              this.resizing.width - coreEvent.deltaX / this.transformScale
          } else {
            newSize.width =
              this.resizing.width + coreEvent.deltaX / this.transformScale
          }
          newSize.height =
            this.resizing.height + coreEvent.deltaY / this.transformScale
    ...
    handleDrag(event) {
      ...
      switch (event.type) {
        ...
        case "dragmove": {
          ...
          if (this.renderRtl) {
            newPosition.left =
              this.dragging.left - coreEvent.deltaX / this.transformScale
          } else {
            newPosition.left =
              this.dragging.left + coreEvent.deltaX / this.transformScale
          }
          newPosition.top =
            this.dragging.top + coreEvent.deltaY / this.transformScale
          if (this.bounded) {
